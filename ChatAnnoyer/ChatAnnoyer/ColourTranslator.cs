...
namespace ChatAnnoyer
{
    ...
    {
        public static Color GetColourFromName(string colorName, Color fallback)
        {
            ...
            Color? color = GetColourFromHex(colorName);
        ...
        public static Color GetColourFromRGB(byte R,byte G,byte B)
        {
            return GetColourFromRGB(R, G, B, 100);
        }
        public static Color GetColourFromRGB(byte R,byte G,byte B,short A)
        {
